...
<main class="page-wrap"><section class="card"><p><a href="admin.php" class="clear-link">Admin Dashboard</a> | <a href="manage_users.php" class="clear-link">Manage Users</a> | <a href="manage_submissions.php" class="clear-link">Manage Submissions</a> | <a href="configure.php" class="clear-link">Configure System</a> | <a href="reports.php" class="clear-link">Reports</a></p><h1>Configure System</h1><p><a href="admin.php" class="clear-link">Back to Admin Dashboard</a></p><?php if ($message !== ''): ?><div class="notice"><?= esc($message) ?></div><?php endif; ?>
